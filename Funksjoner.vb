...
Module Funksjoner
    ...
    Public Function logginnString()
        Dim tilkobling As New MySqlConnection("Server=mysql.stud.iie.ntnu.no;Database=REDACTED_USER;Uid=REDACTED_USER;Pwd=REDACTED")
        Return tilkobling
    End Function

    ' Åpner tilkoblingen til StaySafe databasen.
    Public Function hentTilkobling()
        Dim tilkobling As New MySqlConnection("Server=mysql.stud.iie.ntnu.no;Database=REDACTED_DB;Uid=REDACTED_DB;Pwd=REDACTED")
        Return tilkobling
    End Function
